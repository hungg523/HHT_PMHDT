...
{
    public class ChangePasswordRequestHandler : IRequestHandler<ChangePasswordRequest, ApiResponse>
    {
        ...
        public async Task<ApiResponse> Handle(ChangePasswordRequest request, CancellationToken cancellationToken)
        {
